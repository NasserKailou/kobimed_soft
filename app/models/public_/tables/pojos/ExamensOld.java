...
public class ExamensOld implements Serializable {

    private static final long serialVersionUID = 175992313;
    ...
    public ExamensOld(ExamensOld value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ExamensOld (");
