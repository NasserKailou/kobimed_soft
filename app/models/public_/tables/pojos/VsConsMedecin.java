...
public class VsConsMedecin implements Serializable {

    private static final long serialVersionUID = 341689631;
    ...
    public VsConsMedecin(VsConsMedecin value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("VsConsMedecin (");
