...
public class Ordonances implements Serializable {

    private static final long serialVersionUID = -1809430825;
    ...
    public Ordonances(Ordonances value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("Ordonances (");
