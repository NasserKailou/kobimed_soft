...
public class UsersDao extends DAOImpl<UsersRecord, models.public_.tables.pojos.Users, String> {

    /**
     * Create a new UsersDao without any configuration
     */
    public UsersDao() {
        super(Users.USERS, models.public_.tables.pojos.Users.class);
    }
    ...
    public UsersDao(Configuration configuration) {
        super(Users.USERS, models.public_.tables.pojos.Users.class, configuration);
    }
     ...
     */
    @Override
    protected String getId(models.public_.tables.pojos.Users object) {
     ...
     */
    public List<models.public_.tables.pojos.Users> fetchByLogin(String... values) {
     ...
     */
    public models.public_.tables.pojos.Users fetchOneByLogin(String value) {
     ...
     */
    public List<models.public_.tables.pojos.Users> fetchByDroit(String... values) {
     ...
     */
    public List<models.public_.tables.pojos.Users> fetchByEtat(Boolean... values) {
     ...
     */
    public List<models.public_.tables.pojos.Users> fetchByPasse(String... values) {
     ...
     */
    public List<models.public_.tables.pojos.Users> fetchByWhoDone(String... values) {
     ...
     */
    public List<models.public_.tables.pojos.Users> fetchByWhenDone(Timestamp... values) {
     ...
     */
    public List<models.public_.tables.pojos.Users> fetchByNomPrenom(String... values) {
